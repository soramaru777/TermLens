...
6-2. importance は「この会話を理解するために、ユーザーが今見る価値」を表す。**rarity とは独立に判定すること** — 用語そのものの珍しさ(rarity)と、その会話での表示価値(importance)は別の軸で、片方から他方を決めないこと。会話の主題・意思決定の理解に必要な語、専門技術・製品・フレームワーク・規格・役割名、繰り返し参照される中心概念、誤認識から復元して正しく理解する価値が高い語は high。理解に役立つが主題の中核ではない語は medium。日常語・一般的なビジネス語に近く、文脈が無くても意味を推測でき、解説を読んでも新しい情報がほとんど増えない語は low。**平易な語でもその会話の主題なら high、珍しい語でもその会話では脇役なら low としてよい。** 判断に迷う場合は medium とすること — low は「折りたたんで後回しにしてよい」という積極的な判断であり、迷ったときの既定値ではない。
